...
public struct InitLinable {
  static func makeTheFirstTeam() -> TeamV1 {
    TeamV1(
      ...
      createdAt: Date(),
      updatedAt: Date(),
      lineup: makeLineupWithQuarterReflected(),
      teamPlayers: []
    )
  }
  
  public static func makeTeam(
    teamName: String
  ) -> TeamV1 {
    TeamV1(
      id: UUID(),
  ...
  public static func makeTeamPlayer(
    name: String,
    backNumber: Int
  ) -> TeamPlayerV1 {
    TeamPlayerV1(
  ...
  static func makeLineupWithQuarterReflected() -> [LineupV1] {
    [LineupV1(
      id: UUID(),
      index: 0,
      lineupName: String(
  ...
  static func makeAdditionalLineup() -> LineupV1 {
    LineupV1(
      id: UUID(),
      index: 3,
      lineupName: String(
